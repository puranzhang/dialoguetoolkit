...
import diet.client.ClientInterfaceEvent;
...
public class Transcript_BACKUP2 {
    ...
    private void saveData(String sTurntype, String sEDITS, String selfFULLTURN, String otherFULLTURN, String otherTEXTINWIDOW1){
         String[] row = {sTurntype, sEDITS, selfFULLTURN,otherFULLTURN, otherTEXTINWIDOW1};
          ...
          if(sEDITS.length()>0){
              c.getConvIO().saveTextToFileCreatingIfNecessary("\n"+ sTurntype +  DefaultConversationController.spreadsheetOutputSeparator + sEDITS, fileName);
              latestSaveIsAppendable=true;
          }
          else{
             String textToSave =  sTurntype + DefaultConversationController.spreadsheetOutputSeparator +
                                       sEDITS + DefaultConversationController.spreadsheetOutputSeparator +
                                       selfFULLTURN + DefaultConversationController.spreadsheetOutputSeparator +
                                       otherFULLTURN + DefaultConversationController.spreadsheetOutputSeparator +
                                       otherTEXTINWIDOW1;
