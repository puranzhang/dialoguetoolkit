...
public class JTranscriptFrame2 extends javax.swing.JFrame {
    ...
    public JTranscriptFrame2(Transcript tt, Conversation c, Participant p) {
        super("Server. Port: "+ c.getExpManager().getPortNumberListening()   +"  Transcript:  "+p.getParticipantID()+", "+p.getUsername());
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JTranscriptFrame2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
