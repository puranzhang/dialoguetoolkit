...
public class ParticipantConnection extends Thread {
  ...
  private class ConnectionToClientSendLockFlushingAndPeriodicResetting {
      ...
      public synchronized void sendMessage(Message m) throws Exception{
          ...
          if(DefaultConversationController.debugMESSAGEBLOCKAGE)System.out.println("SINNNNIIII2");
          out.flush();
          if(DefaultConversationController.debugMESSAGEBLOCKAGE)System.out.println("SINNNNIIII3");
          counter++;
          if(DefaultConversationController.debugMESSAGEBLOCKAGE)System.out.println("SINNNNIIII4");
          if(counter>turnsBetweenResets){
              if(DefaultConversationController.debugMESSAGEBLOCKAGE)System.out.println("SINNNNIIII5");
              out.reset();
              if(DefaultConversationController.debugMESSAGEBLOCKAGE)System.out.println("SINNNNIIII6");
              counter =0;
              if(DefaultConversationController.debugMESSAGEBLOCKAGE)System.out.println("SINNNNIIII7");
          }
      }
  }
