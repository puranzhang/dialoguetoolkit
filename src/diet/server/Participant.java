...
public class Participant {
     ...
     */
     public void sendMessage(Message m){
        ...
        if(DefaultConversationController.debugMESSAGEBLOCKAGE)System.out.println("SINP "+getUsername());
        if(participantConnection!=null)participantConnection.send(m);
        if(DefaultConversationController.debugMESSAGEBLOCKAGE)System.out.println("SINQ"+getUsername());
