...
public class CCMAZE_DYADIC_MULTI_2_PARTICIPANTS_SEPARATE_DYADS_MAZEBYMAZE_TIMEOUT_SPLIT_WINDOW_ISTYPINGISMOVING_MARLEEN  extends CCMAZE_DYADIC_MULTI_2_PARTICIPANTS_SEPARATE_DYADS_MAZEBYMAZE_TIMEOUT implements TaskControllerInterface{

    public CCMAZE_DYADIC_MULTI_2_PARTICIPANTS_SEPARATE_DYADS_MAZEBYMAZE_TIMEOUT_SPLIT_WINDOW_ISTYPINGISMOVING_MARLEEN(Conversation c) {
        super(c);
    }
        ...
        //final  static String interface3ISTYPINGISDELETING =   "interface3ISTYPINGISDELETING" ;
    ...
    public synchronized void processChatText(Participant sender, MessageChatTextFromClient mct){    
          ...
          // c.sendArtificialTurnToRecipient(sender, "THE CRIG IS:" +crig.getCurrentValue(mgc), 0);
           ...
           if(interfaceNumber==0){
               ...
               c.deprecated_relayMazeGameTurnToParticipantWithEnforcedColourInMultipleWindow(sender, pRecipient,0, mct, mazeNo, moveNo, indivMveNo,sm.defaultFONTSETTINGSSELF,info); 
           }
            ...
            //c.sendArtificialTurnToRecipientWithEnforcedTextColour(pRecipient, "THIS IS A TEST - PREVIOUS SHOULD BE DELETED "+test, 1, sm.defaultFONTSETTINGSOTHER, info+"UPDATEINFOASTYPED");
           //test=test+1;
          ...
          if ((interfaceNumber==1|interfaceNumber==2) & !isDeleting){
              ...
              itnt.processDELETINGByClient(sender);
               ...
               // c.sendArtificialTurnToRecipientWithEnforcedTextColour(pRecipient, textInBox, 1, sm.defaultFONTSETTINGSOTHER, info+"UPDATEINFOASTYPED");
                c.newsendArtificialTurnFromApparentOriginToRecipient(sender.getUsername(), pRecipient, true, textInBox, info+"UPDATEINFOASTYPED", sm.defaultFONTSETTINGSOTHER , 1, new Vector());
