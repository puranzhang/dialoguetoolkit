...
public class ConversationHistory implements Serializable {
	...
	public synchronized void saveMessageRelayedToOthers(String dtype,long timeOnClientOfStartTyping, long timeOnClientOfSending, long timeOnServerOfReceipt, String senderID, String senderUsername, String apparentSenderUsername, String text,
		...
		NormalTurnProducedByParticipant tbp = new NormalTurnProducedByParticipant(this, dtype, timeOnClientOfStartTyping,timeOnClientOfSending, timeOnServerOfReceipt, senderID, sender, apparentSender, text,
				recipients, wasBlocked, keyPresses, documentUpdates, additionalValues);
        ...
        public synchronized void saveArtificialMessageCreatedByServer(String dtype, long timeOnServerOfSending , String apparentSenderUsername, String text,
			Vector recipientsNames, Vector additionalValues, boolean dummy) {
		...
		ArtificialTurnProducedByServer   atpbs = new ArtificialTurnProducedByServer(this, dtype,  timeOnServerOfSending, sender, "server",  apparentSender, text,
        ...
        public synchronized void saveDataAsRowInSpreadsheetOfTurns(String subdialogueID, String dataType, long timeOnClientOfStartTyping, long timeOnClientOfSending, long timeOnServerOfReceipt, String senderID, String senderUsername, String apparentSenderUsername, String text,
			Vector recipientsNames, boolean wasBlocked, Vector keyPresses, Vector documentUpdates, Vector additionalValues, boolean dummy) {
		...
		// ----------------------------------------------------------------------------
				...
				recipientsNames, wasBlocked, keyPresses, documentUpdates, additionalValues);
