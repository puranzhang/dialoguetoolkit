                            ...
                            if(pA==cTC.participant__state2PersonWhoChooses){
                                   ...
                                   // cTC.cC.getC().sendArtificialTurnFromApparentOriginToRecipient_NoUsername(pA,pA, "**************WHAT IS YOUR JOINT DECISION?****************", cC.getDescriptionForP(p)+"TASKMOVE_PARTICIPANTMADEDIFFERENTSELECTIONS_MUSTMAKECHOICE");
                                    ...
                                    //
                                     ...
                                     cTC.cC.getC().deprecated_sendArtificialTurnToRecipient(pB, "**************WHAT IS YOUR JOINT DECISION?****************", 0,cC.sm.defaultFONTSETTINGSOTHER,  cC.getDescriptionForP(p)+"TASKMOVE_PARTICIPANTMADEDIFFERENTSELECTIONS_DOESNTMAKECHOICE");
                                    ...
                                    //
                                        ...
                                        cTC.cC.getC().deprecated_sendArtificialTurnToRecipient(pA, "**************WHAT IS YOUR JOINT DECISION?****************", 0,cC.sm.defaultFONTSETTINGSOTHER,  cC.getDescriptionForP(p)+"TASKMOVE_PARTICIPANTMADEDIFFERENTSELECTIONS_DOESNTMAKECHOICE");
