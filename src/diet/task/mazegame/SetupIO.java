...
public class SetupIO {
  ...
  public Vector[] loadExternalPairOfMazeVectors(){
      String directory = System.getProperty("user.dir")+File.separator+"experimentresources"+File.separator+"mazegame"+File.separator+"textsets";
    ...
    try {
        BufferedReader br=null;
         if(useExperimentResourcesMazeGame){
          File f = new File(this.mainmazegamelibrary+File.separator+    directoryname+File.separator+"cl1Mazes.txt");
          if(f.exists()){
              br = new BufferedReader(new FileReader(this.mainmazegamelibrary+File.separator+    directoryname+File.separator+"cl1Mazes.txt"));    
          }
          else{
  ...
  public String getClient2MazesStep1_LoadFileASTEXT(String directoryname, boolean useExperimentResourcesMazeGame){
    try {
        BufferedReader br=null;
        if(useExperimentResourcesMazeGame){
          File f = new File(this.mainmazegamelibrary+File.separator+    directoryname+File.separator+"cl2Mazes.txt");
          if(f.exists()){
              br = new BufferedReader(new FileReader(this.mainmazegamelibrary+File.separator+    directoryname+File.separator+"cl2Mazes.txt"));    
          }
          else{
