    ...
    public void doCountdownToNextPartner(Participant a, Participant b,int steps, String message, String cvsPREFIX){
         for(int k=steps;k>0;k--){
            try{
                ...
                mgc.c.changeClientInterface_backgroundColour(a, mgc.c.getController().param_backgroundcolor);
                mgc.c.changeClientInterface_backgroundColour(b, mgc.c.getController().param_backgroundcolor);
