...
public class ClientInterfaceEventTracker  extends Thread{
    ...
    public ClientInterfaceEventTracker(ClientEventHandler ceh) {
     ...
     public synchronized void deprecated_addClientEvent(String type, long timeOfDisplay, String attribname ,   String attribval){
    ...
    public synchronized void addClientEvent(String type, long timeofclientdisplay,  AttribVal...attribvalues){
    ...
    public void run(){
        while(this.trackEvents){
             ...
             if(event instanceof ClientInterfaceEvent){
                 MessageClientInterfaceEvent mcie = new MessageClientInterfaceEvent(ceh.getCts().getEmail(), ceh.getCts().getUsername(),(ClientInterfaceEvent)event);
